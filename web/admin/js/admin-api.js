(function () {
  ...
  window.AdminApi = {
    ...
    pageModules: (params = {}) => adminFetch(withQuery('/admin-api/page-modules', params)),
    pageModulesGrouped: (params = {}) => adminFetch(withQuery('/admin-api/page-modules/grouped', params)),
